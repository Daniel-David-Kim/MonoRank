...
public class FinalBossScript : MonoBehaviour
{
    ...
    public GameObject BossMissile5;
    private float cycleTerm = 1.0f;
    ...
    void Fire()
    {
        ...
        if(timeBuffer >= timeLimit)
        {
            ...
            GameObject missile5 = Instantiate(BossMissile5, m5);
            ...
            missile5.transform.parent = this.transform.parent;
            stock--;
        }
    }
